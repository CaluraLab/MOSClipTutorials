...
sucessCountPathway <- getPathwaysModulesSuccess(perms = permsPathways,
                                                moduleSummary = sPathway)
pathwaySummary <- addResamplingCounts(pathwaySummary, sucessCountModules)
```
...
Here an example of a frequency plot with pathway-type analysis results, after performing the resampling strategy:
```{r}
omicsClasses2pathways <- computeOmicsIntersections(pathwaySummary,
                                                   resampligThr = 80,
                                                   excludeColumns =
